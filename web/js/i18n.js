...
const STRINGS = {
  en: {
    ...
    'route.nearestGrace': 'Nearest grace',
    'route.fromYou': 'From you',
    'route.fromLastSave': 'From your last save',
    'route.here': 'right here',
    'route.lit': 'lit',
    'route.unlit': 'not lit yet',
    'route.otherLayer': "you're on another map layer",
    'route.asCrow': 'Straight line — it ignores cliffs, lifts and locked doors.',
    'unit.m': 'm',
    'unit.km': 'km',
    'dir.N': 'north', 'dir.NE': 'north-east', 'dir.E': 'east', 'dir.SE': 'south-east',
    'dir.S': 'south', 'dir.SW': 'south-west', 'dir.W': 'west', 'dir.NW': 'north-west',
  ...
  ru: {
    ...
    'route.nearestGrace': 'Ближайшая благодать',
    'route.fromYou': 'От вас',
    'route.fromLastSave': 'От последнего сохранения',
    'route.here': 'вы уже здесь',
    'route.lit': 'открыта',
    'route.unlit': 'ещё не открыта',
    'route.otherLayer': 'вы на другом слое карты',
    'route.asCrow': 'По прямой — без учёта обрывов, подъёмников и запертых дверей.',
    'unit.m': 'м',
    'unit.km': 'км',
    'dir.N': 'на север', 'dir.NE': 'на северо-восток', 'dir.E': 'на восток',
    'dir.SE': 'на юго-восток', 'dir.S': 'на юг', 'dir.SW': 'на юго-запад',
    'dir.W': 'на запад', 'dir.NW': 'на северо-запад',
